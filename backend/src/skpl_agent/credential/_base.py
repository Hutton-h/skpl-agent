...
class CredentialBase(BaseModel):
    """The credential base class."""
    id: str = Field(default_factory=_generate_id, description='The credential id')
    name: str = Field(default='', description='User-facing display name for this credential.')
    ...
    def get_chat_model_class(cls) -> Type['ChatModelBase']:
        ...
        """
        raise NotImplementedError(f'{cls.__name__} must implement ``get_chat_model_class``.')
