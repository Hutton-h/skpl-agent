...
class TTSModelBase:
    ...
    def __init__(self, credential: CredentialBase, model: str, parameters: BaseModel | None=None, stream: bool=True) -> None:
    ...
    def list_models(cls, custom_yaml_dir: str | None=None) -> list['TTSModelCard']:
        ...
        for yaml_file in yaml_files:
            try:
                card = TTSModelCard.from_yaml(yaml_path=str(yaml_file), parameter_class=cls.Parameters)
