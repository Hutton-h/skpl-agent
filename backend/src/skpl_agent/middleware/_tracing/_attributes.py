...
class SpanAttributes:
    ...
    AGENTSCOPE_CACHE_INPUT_TOKENS = 'skpl_agent.usage.cache_input_tokens'
    'The number of input tokens read from prompt cache.'
    AGENTSCOPE_CACHE_CREATION_INPUT_TOKENS = 'skpl_agent.usage.cache_creation_input_tokens'
    'The number of input tokens used to create prompt cache.'
    AGENTSCOPE_REPLY_ID = 'skpl_agent.agent.reply_id'
    ...
    AGENTSCOPE_HITL_PENDING_TOOLS = 'skpl_agent.agent.hitl_pending_tools'
    ...
    AGENTSCOPE_EXTERNAL_EXECUTION_PENDING_TOOLS = 'skpl_agent.agent.external_execution_pending_tools'
    'JSON list of tool names submitted for external execution.\n\n    Set on the first ``invoke_agent`` span when the agent pauses due to a\n    ``RequireExternalExecutionEvent``.\n    '
    AGENTSCOPE_INCOMING_EVENT_TYPE = 'skpl_agent.agent.incoming_event_type'
    'Type of the continuation event passed to the second reply call.\n\n    Possible values: ``"user_confirm_result"``,\n    ``"external_execution_result"``.\n    '
    AGENTSCOPE_IS_EXTERNAL_EXECUTION = 'skpl_agent.agent.is_external_execution'
