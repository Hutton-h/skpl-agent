...
tts_model_router = APIRouter(prefix='/tts-model', tags=['tts-model'], responses={404: {'description': 'Not found'}})

@tts_model_router.get('/', response_model=ListTTSModelsResponse, summary='List all candidate TTS models under the given credential type')
async def list_tts_models(body: ListTTSModelsRequest=Depends()) -> ListTTSModelsResponse:
