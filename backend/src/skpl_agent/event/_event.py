...
from ..message import DataBlock, TextBlock, ToolCallBlock, ToolResultBlock, ToolResultState
...
@deprecated('ReplyEndReason is deprecated and will be removed; use agentscope.types.ReplyFinishedReason instead.')
class ReplyEndReason(str, Enum):
...
class CustomEvent(EventBase):
    ...
    'Arbitrary payload.'
AgentEvent: TypeAlias = ReplyStartEvent | ReplyEndEvent | ExceedMaxItersEvent | RequireUserConfirmEvent | RequireExternalExecutionEvent | ModelCallStartEvent | ModelCallEndEvent | TextBlockStartEvent | TextBlockDeltaEvent | TextBlockEndEvent | DataBlockStartEvent | DataBlockDeltaEvent | DataBlockEndEvent | ThinkingBlockStartEvent | ThinkingBlockDeltaEvent | ThinkingBlockEndEvent | HintBlockEvent | ToolCallStartEvent | ToolCallDeltaEvent | ToolCallEndEvent | ToolResultStartEvent | ToolResultTextDeltaEvent | ToolResultDataDeltaEvent | ToolResultEndEvent | UserConfirmResultEvent | UserInterruptEvent | ExternalExecutionResultEvent | CustomEvent