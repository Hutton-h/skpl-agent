...
ContentBlock: TypeAlias = TextBlock | ThinkingBlock | HintBlock | ToolCallBlock | ToolResultBlock | DataBlock
ContentBlockTypes: TypeAlias = Literal['text', 'thinking', 'hint', 'tool_call', 'tool_result', 'data']